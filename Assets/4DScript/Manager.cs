...
{
    public class Manager : GlobalReceiver, IGlobalTriggerPressSetHandler, IGlobalGripHandler, IGlobalTouchpadPressDownHandler , IGlobalTouchpadTouchSetHandler {//, IGlobalApplicationMenuPressDownHandler{
        public Material[] mat;
